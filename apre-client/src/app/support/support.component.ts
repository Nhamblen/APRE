...
@Component({
      ...
      <div class="support__cards">
        <div class="card support__card">
          ...
          <div class="card__body support__card-body">
            <p class="support__card-content">Email: <a class="link--primary" href="mailto:support@example.com">support&#64;example.com</a></p>
        ...
        <div class="card support__card">
          ...
          <div class="card__body support__card-body">
            <ul class="support__card-list">
              <li class="support__card-list-item"><a class="link--primary" href="https://example.com/docs/getting-started" target="_blank">Getting Started</a></li>
              <li class="support__card-list-item"><a class="link--primary" href="https://example.com/docs/user-guide" target="_blank">User Guide</a></li>
              <li class="support__card-list-item"><a class="link--primary" href="https://example.com/docs/api-reference" target="_blank">API Reference</a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  `,
  // Added link--primary to links so global styling is more consistent (minor development 10/28/25)
  styles: `
    .support {
      padding: 20px;
